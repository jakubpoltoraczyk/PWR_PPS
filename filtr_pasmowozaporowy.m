...
% Widmo amplitudowe sygnalu (przed filtracja)
...
subplot(324);
plot(fh,wh(1:N21h));
title('Moduł transmitancji filtru');
xlabel('Czestotliwosc [Hz]');
ylabel('Modul transmitancji');

% Przebieg czasowy (po filtracji)
...
subplot(326);
plot(f,wy(1:N21));
title('Widmo amplitudowe po filtracji');
xlabel('Czestotliwosc [Hz]');
ylabel('Widmo amplitudowe');